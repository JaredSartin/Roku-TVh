sub init()
  ...
  ' m.keyboard = m.top.findNode("settingsKeyboard")
  ' keyboardRect = m.keyboard.boundingRect()
  ' centerx = (1920 - keyboardRect.width) / 2
  ' m.keyboard.translation = [ centerx, 600 ]
